...
\require_login(true);
\check_access("/dashboard", true, "project-dev");
...
<html lang="en" dir="ltr" manifest="<?php echo WHOST; ?>/site.webmanifest">
  <head>
    <meta charset="utf-8">
    <title>Dev dashboard | <?php echo PRJ_TITLE; ?></title>
    ...
    <section id="main-content">
      <div class="view-space">
        ...
        <div class="grid-10-tablet grid-8-desktop center-tablet">
          <!-- dashlist -->
          <ul class="dash-list">
            <?php if ($navs): foreach($navs as $dash){ if( !\in_array($dash['link'], [THIS_PAGE, THIS_PAGE . '/']) ){ ?>
